        ...
        <div style={{ 
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            <div style={{ display: 'flex', gap: '12px' }}>
              ...
              <div>
                <h4 style={{ fontSize: '0.9rem', fontWeight: 700, marginBottom: '2px' }}>Content Moderation</h4>
                <p style={{ fontSize: '0.8rem', color: 'var(--text-muted)' }}>
                  Help keep our community safe and high-quality by reviewing and moderating user-submitted sightings.
                </p>
              </div>
            </div>
          </div>
